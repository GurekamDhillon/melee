...
the platform shims, and run `melee-pc.exe --iso <your GALE01 v1.02 image>`. Third-party components
and their licences are listed in [`DEPENDENCIES.md`](DEPENDENCIES.md).
